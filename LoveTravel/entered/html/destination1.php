...
<body>
    <div class="web">
        <!-- Header -->
        <header class="header-destination" style="background-image: url(../../assets/img/header-background-destination.jpg);">
            <div class="navbar">
            ...
            <div class="grid wide  ">
                <div class="header-destination-title">
                    <span class="header-destination-title-text">Europe</span>
                </div>
            </div>
        </header>
                            ...
                            <div class="body-info__container">
                                <div class="body-info__item">
                                    ...
                                    <div class="body-info__item-info">
                                        ...
                                        <span class="body-info__item-info-description">3 Tours in Europe</span>
                                    </div>
                                </div>
