...
<body>
    <div class="web">
        <!-- Header -->
        <header class="header-destination" style="background-image: url(../../assets/img/header-background-destination3.jpg);">
            <div class="navbar">
            ...
            <div class="grid wide  ">
                <div class="header-destination-title">
                    <span class="header-destination-title-text">Asia</span>
                </div>
            </div>
        </header>
                            ...
                            <div class="body-info__container">
                                <div class="body-info__item">
                                    ...
                                    <div class="body-info__item-info">
                                        ...
                                        <span class="body-info__item-info-description">2 Tours in Asia</span>
                                    </div>
                                </div>
                                ...
                                <div class="body-info__item">
                                    ...
                                    <div class="body-info__item-info">
                                        <span class="body-info__item-info-heading">Asia</span>
                            ...
                            <form action="../../cart/cart.php" method ="post">
                                ...
                                <div class="package__item">
                                    <div class="package__item-img">
                                        ...
                                        <div style="background: linear-gradient(to right, #14b9d5 0%, #14d5b1 100%);" class="package__item-img-icon-container ">
