...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/destinationresponsive.css">
     ...
     <title>Love Travel - Sport</title>
</head>
<body>
    <div class="web">
        <!-- Header -->
        <header class="header-destination" style="background-image: url(../../assets/img/sport-background.jpg);">
            <div class="navbar">
            ...
            <div class="grid wide  ">
                <div class="header-destination-title">
                    <span class="header-destination-title-text">Sport</span>
                </div>
            </div>
        </header>
