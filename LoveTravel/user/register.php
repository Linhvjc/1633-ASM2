      ...
      <div class="page-container">
         ...
         <div class="container-right">
            <div class="container-right__content">
               ...
               ?>
                  <label class="label-form" for="email-input">Username</label>
                  <input class="input-form" type="text" name="name" placeholder="Your username..." class="box user-input" required>
                  <label class="label-form" for="email-input">Email</label>
                  <input class="input-form" type="email" name="email" placeholder="Your email..." class="box user-input" required>
                  <label class="label-form" for="email-input">Password</label>
                  <input class="input-form" type="password" name="password" placeholder="Your password..." class="box user-input" required>
                  <label class="label-form" for="email-input">Repassword</label>
                  <input class="input-form" type="password" name="cpassword" placeholder="Confirm your password..." class="box user-input" required>
                  <label class="label-form" for="email-input">Avatar</label>
                  <input class="input-form" type="file" name="image" class="box" accept="image/jpg, image/jpeg, image/png">
