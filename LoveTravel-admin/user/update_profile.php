...
<body class="preloading">
   <div class="web">
      ...
      <div class="update-profile background-login">
            ...
            <form action="" method="post" enctype="multipart/form-data">
               ...
               <div class="flex">
                  <div class="inputBox">
                     ...
                     <input style="background-color: rgba(0 , 0, 0, 0.2); border: none;" readonly class="input-form" type="email" name="update_email" value="<?php echo $fetch['email']; ?>" class="box">
