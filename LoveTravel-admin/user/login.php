...
if(isset($_POST['submit'])){
   ...
   $row = mysqli_fetch_assoc($select);
    if($row['email'] == 'phanphanvjc@gmail.com'){

        $_SESSION['admin'] = $row['id'];
        header('location:admin.php');

    }elseif($row['email'] != 'phanphanvjc@gmail.com' && mysqli_num_rows($select) > 0){
            ...
            <div class="container-right__content">
               ...
               <form class="container-right__form" action="" method="post" enctype="multipart/form-data">
                  ...
                  <div class="btn-form__container">
                     <input type="submit" name="submit" value="Sign in" class="btn form-btn">
                  </div>
                  ...
                  <div id="login-with-social">
                    ...
                    if(isset($authUrl)){ 
                    ?>
                    <a class="login__google" href="<?= $authUrl ?>"><img class="login__google-img" src="./images/google1.png" alt='google login' title="Google Login" /></a>
                    <?php } 
                    ?>
                  </div>
